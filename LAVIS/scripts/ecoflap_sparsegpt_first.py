...
job_id = f"cc3m-{method}_{ratios}_aobd_sum0.7_block"

sparsity_dict = f"cc3m-blipt5_wanda_pruner_0.4-1.0-1.0_aobd_sum0.7_block"

program = (f"CUDA_VISIBLE_DEVICES={GPU} python -m torch.distributed.run"
f" --nproc_per_node=1 --master_port {port} evaluate_new.py"

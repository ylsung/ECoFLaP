...
do
    ...
    CUDA_VISIBLE_DEVICES=$1 python run_seq2seq.py \
        ...
        --output_dir outputs/${file_name}_2 \
        --gate_type "all_from_side"

    cp outputs/${file_name}_2/all_results.json  all_output_logs/pruning_$task@${seed}.json

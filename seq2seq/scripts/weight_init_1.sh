...
log_file_name=${model_name_or_path}_${side_pretrained_weight}_${file_name}_optLR_${distillation_init}_permute_ffnLM_take_first_merge_last
output_dir=${home_path}/data/outputs/${file_name}_1

for seed in 0
do

for task in "rte" "mnli" "qqp" "stsb" "winogrande_debiased" "squad_v2" "superglue-record" "superglue-multirc" "superglue-boolq" "superglue-cb" "superglue-multirc" "superglue-wic" "superglue-copa"
...
log_file_name=${model_name_or_path}_${side_pretrained_weight}_${file_name}_optLR_${distillation_init}_permute_ffn_take_first_merge_last
output_dir=${home_path}/data/outputs/${file_name}_1

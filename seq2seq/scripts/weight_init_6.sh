...
log_file_name=${model_name_or_path}_${side_pretrained_weight}_${file_name}_optLR_${distillation_init}_permute_on_block_three_merge_last
...
log_file_name=${model_name_or_path}_${side_pretrained_weight}_${file_name}_optLR_${distillation_init}_permute_on_block_ffnLM_three_merge_last
output_dir=${home_path}/data/outputs/${file_name}_6
...
log_file_name=${model_name_or_path}_${side_pretrained_weight}_${file_name}_optLR_${distillation_init}_permute_on_block_ffn_three_merge_last
output_dir=${home_path}/data/outputs/${file_name}_6

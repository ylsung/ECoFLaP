...
class TransformerLayerWandaPruner(LayerWiseBasePruner):
    pruner_name = "transformer_wanda_pruner"
    def __init__(
        self,
        model,
        data_loader,
...
class CLIPLayerWandaPruner(LayerWiseBasePruner):
    pruner_name = "clip_wanda_pruner"
    def __init__(
        self,
        model,
        data_loader,
    ...
    def prune(self, importance_scores=None, keep_indices_or_masks=None):
        ...
        if self.visual_prune_spec is not None:
            ...
            _visual_prune = partial(TransformerLayerWandaPruner._prune, self)
            self.prepare_calibration_input_encoder = partial(
                TransformerLayerWandaPruner.prepare_calibration_input_encoder,
                self,
                )
        ...
        if self.language_prune_spec is not None:
            ...
            _language_prune = partial(TransformerLayerWandaPruner._prune, self)
            self.prepare_calibration_input_encoder = partial(
                TransformerLayerWandaPruner.prepare_calibration_input_encoder,
                self,
                )

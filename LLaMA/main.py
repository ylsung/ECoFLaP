...
def get_llm(model, cache_dir="llm_weights"):
    model = AutoModelForCausalLM.from_pretrained(
        ...
        # cache_dir=cache_dir, 
        # load_in_8bit=True,# if "65b" or "70b" in model else False,
...
def main():
    ...
    parser.add_argument('--max_sparsity_per_layer', type=float, default=0.8)
    parser.add_argument('--aggregate_method', type=str, default="avg")
    parser.add_argument('--score_method', type=str, default="GradOnly")
    parser.add_argument('--use_mezo', action="store_true")
